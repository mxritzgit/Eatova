...
| B08 | Serverseitige Eingabevalidierung | TEILWEISE | P2 | CODE/TEST: begrenzte Bodies/Normalisierung; fremde Privilegfelder ohne Rechtewirkung. S05 in Runde 2 durch Base64-/Containerprüfung vor bezahlter Analyse geschlossen. | S05 als Version 30 bereitgestellt; vollständige serverseitige Feld-/Grenzmatrix ergänzen. |
...
| D04 | Uploadgröße und tatsächlicher Dateityp | TEILWEISE | P2 | CODE/TEST: Client reencodiert; Server prüft Base64 und JPEG-/PNG-/WebP-Container vor Tages-/Globalkontingent, Runde 2/S05. | Version 30 bereitgestellt; erlaubte/unerlaubte Direktaufrufe im freigegebenen Testsystem; D05 bleibt getrennt. |
...
| G07 | Geprüfte Ausgaben/Darstellung/Links/Bilder | TEILWEISE | P1 | CODE/TEST: Schema-/Typgrenzen und Textdarstellung vorhanden; S01 in Runde 2 blockiert gefilterte Antworten/Entwürfe vor Übergabe und Bildfolgeaufruf. | Schemas bis bestätigte Aktion und externe Medien vollständig prüfen; Version 47 bereitgestellt. |
...
| I03 | Einwilligungen und zutreffende Information | TEILWEISE | P1 | CODE/TEST: DE/EN-Infosheet korrigiert, vier tatsächliche Sheet-Regressionen. LIVE: öffentliche Datenschutzseite korrigiert, Modellkonfiguration bestätigt; Veröffentlichungsnachweis oben und Runde 2/S07. | Anbieter-Verträge, Datennutzung und Aufbewahrung prüfen; Rechtsgrundlagen/Einwilligung fachlich prüfen. |
